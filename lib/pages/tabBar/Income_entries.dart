...
class IncomeEntries extends StatefulWidget {
  const IncomeEntries({Key key}) : super(key: key);

  @override
  _IncomeEntriesState createState() => _IncomeEntriesState();
}

class _IncomeEntriesState extends State<IncomeEntries> {
